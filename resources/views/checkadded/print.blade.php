    ...
    <div class="col-md-12">
        <div class="card shadow-sm border-0 rounded-3">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center rounded-top">
                ...
                <button type="button" class="btn btn-light btn-sm no-print" style="background-color: white !important; color: #2b4b7b !important;" data-bs-toggle="modal" data-bs-target="#printOptionsModal">
                    🖨️ Print Report
                </button>
            </div>
            ...
            <div class="card-body">
                ...
                @if($hasFilter)
                    {{-- ✅ show table only when filters are used --}}
                                ...
                                <tbody>
                                    @forelse($cheques as $cheque)
                                        <tr>
                                            ...
                                            <td name="check_amount"><strong>₱ {{ number_format($cheque->amount, 2) }}</strong></td>
